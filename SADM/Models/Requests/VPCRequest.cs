...
namespace SADM.Models.Requests
{
    public class VPCRequest
    {
        ...
        { 
            //_address = "";
            _merchantID = SADM.Settings.AppConfiguration.Values.vpc_Merchant;
            _accessCode = SADM.Settings.AppConfiguration.Values.vpc_AccessCode;
            _vpcCommand = SADM.Settings.AppConfiguration.Values.vpc_Command;
            _vpcVersion = SADM.Settings.AppConfiguration.Values.vpc_Version;
            _secureSecret = SADM.Settings.AppConfiguration.Values.SecureSecret;
        }
